...
I promise to show you in the [next episode]({% link topics/crdt/04-combinators.md %}).
...
But it requires a lot more prose, so it's reserved for the [next episode]({% link topics/crdt/04-combinators.md %}).
