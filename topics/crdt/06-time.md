...
<div>
  <img src="{% asset topics/crdt/lamport-clock.svg @path %}" alt="see text below for a description">
</div>
...
<div>
  <img src="{% asset topics/crdt/convergence.svg @path %}" alt="see text below for a description">
</div>
