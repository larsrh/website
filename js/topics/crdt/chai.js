(function (global, factory) {
	...
	(global = global || self, factory(global.chai = {}));
	...
	*/
	...
	var MemoizeMap$1 = typeof WeakMap === 'function' ? WeakMap : FakeMap$1;
	/*!
	 * Check to see if the MemoizeMap has recorded a result of the two operands
	 *
	 * @param {Mixed} leftHandOperand
	...
	*/
	...
	function extensiveDeepEqualByType$1(leftHandOperand, rightHandOperand, leftHandType, options) {
	  switch (leftHandType) {
	    ...
	    case 'WeakSet':
	      return leftHandOperand === rightHandOperand;
	    case 'Error':
	      return keysEqual$1(leftHandOperand, rightHandOperand, [ 'name', 'message', 'code' ], options);
	    case 'Arguments':
	    case 'Int8Array':
	    case 'Uint8Array':
	    case 'Uint8ClampedArray':
	...
	deepEql$1.MemoizeMap = MemoizeMap_1$1;

	const assert$1 = chai$1.assert;

	exports.assert = assert$1;
	exports.deepEqual = deepEql$1;
