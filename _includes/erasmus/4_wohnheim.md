...
Am Samstag hingegen wurde indisches Ei-Curry zubereitet. Die Zutaten
...
<div class="row mt-3 mb-3">
  {% include erasmus/picture.html src="mitgedacht" text="Hier hat jemand mitgedacht" %}
</div>
...
Heute sollte es eigentlich Ulster Fry in der Student’s Union geben, aber
...
<div class="row mt-3 mb-3">
  {% include erasmus/picture.html src="change-button" text="Change Button" %}
</div>
...
<div class="row mt-3 mb-3">
  {% include erasmus/picture.html src="cooker" text="Es steht ein Herd auf dem Flur" %}
</div>
...
Nun denn. Folgende E-Mail erreichte mich kürzlich von der
Wohnheimsverwaltung:
